...
patch_fstab fstab.h1 /data ext4 flags "forceencrypt=" "encryptable=";
replace_section init.h1.power.rc "service triton" " " "service triton /system/vendor/bin/triton\n   class main\n   user root\n   group system\n   socket triton-client stream 660 system system\n   disabled\n   oneshot\n";
