...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 12, 0) || defined (CONFIG_KERNEL_MODV)
...
check_bss:
	...
	if (rtw_to_roam(padapter) > 0) {
		...
		#if defined (CONFIG_KERNEL_MODV)
		cfg80211_roamed2(padapter->pnetdev, &roam_info, GFP_ATOMIC);
		#else
