...
#undef BT_INFO
#define BT_INFO(fmt, arg...) printk(KERN_ERR "*[bluetooth_pm(%d)-%s()] " fmt "\n" , __LINE__, __FUNCTION__, ## arg)
#undef BT_ERR
#define BT_ERR(fmt, arg...)  printk(KERN_ERR "*[bluetooth_pm(%d)-%s()] " fmt "\n" , __LINE__, __FUNCTION__, ## arg)
#undef BT_DBG
#define BT_DBG(fmt, arg...)  printk(KERN_ERR "*[bluetooth_pm(%d)-%s()] " fmt "\n" , __LINE__, __FUNCTION__, ## arg)
