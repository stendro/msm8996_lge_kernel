...
{
#if defined(CONFIG_LGE_PM_USB_CURRENT_MAX_MODE) || defined(CONFIG_LGE_PM_VZW_REQ) || \
    defined(CONFIG_LGE_PM_LLK_MODE) || defined(CONFIG_LGE_PM_LGE_POWER_CLASS_TDMB_MODE)
