...
static void bfq_init_entity(struct bfq_entity *entity, struct bfq_group *bfqg)
{
...
new_queue:
	...
	bfqq->allocated++;
	bfqq->ref++;
	bfq_log_bfqq(bfqd, bfqq, "set_request %p: bfqq %p, %d",
		     rq, bfqq, bfqq->ref);
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Budget Fair Queueing I/O Scheduler");
